...
public class TelemetryParser {
  ...
  public static List<TelemetryMessage> parseTelemetryJson(String json, boolean print){
    TelemetryMessage message;
    long timeStamp;
    String deviceId;
    ArrayList<SensorData> data;
    JsonObject jsonObject;
    List<TelemetryMessage> array = new ArrayList<>();
  ...
  public static List<TelemetryMessage> parseTelemetryJsons(String json){
